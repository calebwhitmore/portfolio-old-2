var plugins = [{
      ...
      plugin: require('/Users/CalebWhitmore/git/portfolio/node_modules/gatsby-plugin-react-helmet/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-plugin-google-analytics',
      plugin: require('/Users/CalebWhitmore/git/portfolio/node_modules/gatsby-plugin-google-analytics/gatsby-ssr'),
      options: {"plugins":[],"trackingId":"UA-61090085-1","head":false,"anonymize":false,"respectDNT":false,"exclude":[],"pageTransitionDelay":0},
    },{
      name: 'gatsby-plugin-manifest',
      plugin: require('/Users/CalebWhitmore/git/portfolio/node_modules/gatsby-plugin-manifest/gatsby-ssr'),
